    ...
    for exp in ctx.document.experiences:
      for level in exp.levels:
        ...
        for r in rules:
            ...
            rows.append({'game_id':exp.game_id,'level_id':level.level_id,'adaptation_id':r.adaptation_id,'function_name':fn,'action':r.action.value,'priority':r.priority,'target_id':r.target_id})
