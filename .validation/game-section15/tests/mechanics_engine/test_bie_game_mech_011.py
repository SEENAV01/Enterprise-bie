...
ctx=sample_context
from bie.game_engine.mechanics_engine import equation_balance
def valid():return equation_balance.execute(ctx(),{},2,2,'add',3)
def invalids():return [(lambda:equation_balance.execute(ctx(),{},2,2,'div',0)),(lambda:equation_balance.execute(ctx(),{},2,3,'pow',2))]
from bie.game_engine.mechanics_engine import equation_balance as MODULE
