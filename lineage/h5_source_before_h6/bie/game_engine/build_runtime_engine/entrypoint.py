ENTRY_JS = r'''import { bootstrap, runtimeBindings } from "./bootstrap.js";
globalThis.__BIE_GAME_ASSETS__ = Object.freeze(__ASSET_BINDINGS__);
const React = {
  createElement(tag, props = {}, ...children) {
    ...
    for (const [key, value] of Object.entries(props || {})) {
      ...
      else if (key === "tabindex") el.setAttribute("tabindex", String(value));
...
const controller = bootstrap(React, mount);
globalThis.__BIE_GAME_RUNTIME__ = Object.freeze({
  booted:true,
  ...
  getTelemetry:controller.getTelemetry,
  actionIds:controller.actionIds,
  playNarration:controller.playNarration,
