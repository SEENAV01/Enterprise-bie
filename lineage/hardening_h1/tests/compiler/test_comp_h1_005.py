...
class CheckedCompilationTests(unittest.TestCase):
    ...
    def test_remaining_typesetting_defect_blocks(self):self.assertFalse(compile_scene_checked(scene('equation',{'expression':'x^2','format':'latex'}))[1].source_gate_passed)
