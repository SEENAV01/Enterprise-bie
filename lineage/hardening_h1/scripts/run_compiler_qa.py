...
def main() -> int:
    ...
    p.add_argument('--corpus', type=Path, default=root / 'fixtures/comp_h1/extended_corpus.json')
    p.add_argument('--baselines', type=Path, default=root / 'fixtures/comp_h1/baselines')
