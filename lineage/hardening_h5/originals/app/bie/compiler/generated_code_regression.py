...
def typecheck_generated_workspace(workspace: Path, *, tsc_bin: str | None = None,
                                  timeout_s: float = 90) -> TypecheckGate:
    ...
    coverage = run_bounded_process((executable, "--project", str(root / "tsconfig.json"),
    ...
    process = run_bounded_process((executable, "--project", str(root / "tsconfig.json"),
