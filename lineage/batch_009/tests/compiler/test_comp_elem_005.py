...
class T(unittest.TestCase):
 ...
 def test_bar(self):self.assertIn("maxValue",compile_chart_element(self.e()).source_text)
 def test_kind(self):self.assertIn('data-chart-kind={"bar"}',compile_chart_element(self.e()).source_text)
 def test_fallback_warning(self):self.assertTrue(compile_chart_element(self.e("pie")).warnings)
 def test_bad(self):
