...
class T(unittest.TestCase):
 def test_compile_mixed_element_source_tree(self):
  ...
  elements=[
    ...
    (compile_map_element,{"element_id":"m","element_type":"map","props":{"crs":"EPSG:4326","layers":[{"kind":"route","points":[[0,0],[1,1]]}]},**base}),
    ...
    (compile_simulation_element,{"element_id":"s","element_type":"simulation","props":{"model_ref":"m","initial_state":{}},**base}),
