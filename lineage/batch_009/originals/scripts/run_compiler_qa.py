...
def main() -> int:
    ...
    p.add_argument('--corpus', type=Path, default=root / 'fixtures/comp_qa_009/corpus.json')
    p.add_argument('--baselines', type=Path, default=root / 'fixtures/comp_qa_009/baselines')
