...
def main():
    ...
    try:
        if args.layout_policy is not None:
            ...
            result=repair_and_publish(json.loads(args.scene.read_text()),json.loads(args.layout_policy.read_text()),args.destination,args.layout_evidence,browser=args.browser,motion_preference=args.motion_preference)
