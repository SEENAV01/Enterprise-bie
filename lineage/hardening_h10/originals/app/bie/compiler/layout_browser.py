...
class ChromiumLayoutProbe:
    ...
    def measure(self, result, target, output: Path, *, screenshots: bool = False, paint_checks: bool = False) -> dict:
        ...
        errors = []; observations = []; screenshot_records = []; network = []; paint_records = []
