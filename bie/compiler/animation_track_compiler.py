...
def compile_animation_track(track, *, element=None, typesetter=None):
    ...
    if is_registered(track):
        from .registered_action_compiler import compile_registered_track
        return compile_registered_track(track, element, typesetter=typesetter)
