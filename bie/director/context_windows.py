...
class ContextSlice:
    ...
    def model_data(self):
        ...
        if 'rich_teaching' in data:
            data['rich_teaching']['strategies']=[row for row in data['rich_teaching']['strategies'] if row['concept_id'] in selected]
            data['rich_teaching']['obligations']=[row for row in data['rich_teaching']['obligations'] if row['concept_id'] in selected]
            data['rich_teaching']['coverage']={key:value for key,value in data['rich_teaching']['coverage'].items() if key in selected}
