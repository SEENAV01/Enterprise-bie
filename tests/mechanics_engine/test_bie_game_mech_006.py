...
ctx=sample_context
from bie.game_engine.mechanics_engine import construct_model
def valid():return construct_model.execute(ctx(),{},[{'id':'base','requires':[]},{'id':'arm','requires':['base']}],('base','arm'))
def invalids():return [(lambda:construct_model.execute(ctx(),{},[{'id':'a','requires':['x']}],('a',))),(lambda:construct_model.execute(ctx(),{},[{'id':'a','requires':['b']},{'id':'b','requires':['a']}],('a','b')))]
from bie.game_engine.mechanics_engine import construct_model as MODULE
