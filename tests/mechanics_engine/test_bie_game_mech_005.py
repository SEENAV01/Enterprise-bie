...
ctx=sample_context
from bie.game_engine.mechanics_engine import classify_sort
def valid():return classify_sort.execute(ctx(),{},[{'id':'i1','class':'A'},{'id':'i2','class':'B'}],{'i1':'A','i2':'B'},('A','B'))
def invalids():return [(lambda:classify_sort.execute(ctx(),{},[{'id':'i1'}],{'i1':'A'},('A',))),(lambda:classify_sort.execute(ctx(),{},[{'id':'i1','class':'A'}],{'i1':'X'},('A',)))]
from bie.game_engine.mechanics_engine import classify_sort as MODULE
