...
ctx=sample_context
from bie.game_engine.mechanics_engine import simulation_experiment
def valid():return simulation_experiment.execute(ctx(),{},(0,1,2),{'kind':'linear','parameters':{'coefficient':2,'offset':1}})
def invalids():return [(lambda:simulation_experiment.execute(ctx(),{},(),{'kind':'linear','parameters':{'coefficient':2,'offset':1}})),(lambda:simulation_experiment.execute(ctx(),{},(1,),{'kind':'black_box','parameters':{}}))]
from bie.game_engine.mechanics_engine import simulation_experiment as MODULE
