...
def valid():return parameter.execute(ctx(),{'value':2.0},1.5,(0,10))
def invalids():return [(lambda:parameter.execute(ctx(),{'value':9.5},1,(0,10))),(lambda:parameter.execute(ctx(),{'value':'x'},1,(0,10)))]
from bie.game_engine.mechanics_engine import parameter as MODULE
