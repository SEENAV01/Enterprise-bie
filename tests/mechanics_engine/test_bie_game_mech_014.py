...
ctx=sample_context
from bie.game_engine.mechanics_engine import diagnose_error
def valid():return diagnose_error.execute(ctx(),{},[{'actual':'4','expected':'4','evidence_ref':'s1'},{'actual':'5','expected':'4','evidence_ref':'s2'}])
def invalids():return [(lambda:diagnose_error.execute(ctx(),{},[])),(lambda:diagnose_error.execute(ctx(),{},[{'actual':'x'}]))]
from bie.game_engine.mechanics_engine import diagnose_error as MODULE
