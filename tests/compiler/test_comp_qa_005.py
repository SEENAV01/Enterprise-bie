...
class MultidomainBenchmarkTests(unittest.TestCase):
    ...
    def test_fifteen_positive_source_cases_pass(self):self.assertEqual(self.receipt.positive_source_passes,15)
    def test_four_remaining_base_negative_cases_are_not_positive_outputs(self):
        self.assertEqual(self.receipt.negative_cases_detected,4)
