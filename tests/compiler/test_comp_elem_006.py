...
class T(unittest.TestCase):
 def e(self):return {"element_id":"m","element_type":"map","props":{"crs":"EPSG:4326","attribution":"Synthetic fixture","projection":{"kind":"web_mercator","axis_order":"lon_lat","extent":[0,0,1,1]},"layers":[{"kind":"route","points":[[.1,.2],[.9,.8]]}]},"accessibility":{"alt":"route"},"source_refs":["s"],"reasoning_refs":["r"]}
