...
def generate_remotion_project(scene_dsl, output_dir):
    out = Path(output_dir)
    # Accept either a workspace root or the canonical generated directory.
    # Tests and callers historically pass the workspace root.
    remotion = out / "generated" / "remotion" if out.name != "generated" else out / "remotion"
    src = remotion / "src"
