...
const chart: ChartGeometry = {"area_points": "64,194.285714286 64,316 334,153.714285714 604,32 604,194.285714286", "bars": [], "baseline": 194.28571428571428, "bottom": 316.0, "categories": ["A", "B", "C"], "domain": [-3.0, 4.0], "height": 400, "kind": "area", "left": 64.0, "line_points": "64,316 334,153.714285714 604,32", "points": [{"index": 0, "label": "A", "value": -3.0, "x": 64.0, "y": 316.0}, {"index": 1, "label": "B", "value": 1.0, "x": 334.0, "y": 153.71428571428572}, {"index": 2, "label": "C", "value": 4.0, "x": 604.0, "y": 32.0}], "right": 604.0, "slices": [], "top": 32.0, "units": "", "values": [-3.0, 1.0, 4.0], "width": 640, "x_label": "", "y_label": ""};
export const Chart_e0_5c88e7a2: React.FC = () => (
  <figure style={{margin: 0, width: "100%", height: "100%", display: "grid", gridTemplateRows: "minmax(0, 1fr) auto"}}>
    <svg viewBox="0 0 640 400" width="100%" height="100%" role="img"
      aria-label={"Synthetic technical fixture h1-area-signed"} data-chart-kind={"area"}>
