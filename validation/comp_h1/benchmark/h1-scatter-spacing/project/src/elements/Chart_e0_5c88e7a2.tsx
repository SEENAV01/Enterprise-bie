...
const chart: ChartGeometry = {"area_points": "", "bars": [], "baseline": 245.0, "bottom": 316.0, "categories": ["P", "Q", "R"], "domain": [-1.0, 3.0], "height": 400, "kind": "scatter", "left": 64.0, "line_points": "", "points": [{"index": 0, "label": "P", "value": -1.0, "x": 64.0, "y": 316.0}, {"index": 1, "label": "Q", "value": 3.0, "x": 172.0, "y": 32.0}, {"index": 2, "label": "R", "value": 0.0, "x": 604.0, "y": 245.0}], "right": 604.0, "slices": [], "top": 32.0, "units": "", "values": [-1.0, 3.0, 0.0], "width": 640, "x_domain": [0.0, 10.0], "x_label": "", "x_values": [0.0, 2.0, 10.0], "y_label": ""};
export const Chart_e0_5c88e7a2: React.FC = () => (
  <figure style={{margin: 0, width: "100%", height: "100%", display: "grid", gridTemplateRows: "minmax(0, 1fr) auto"}}>
    <svg viewBox="0 0 640 400" width="100%" height="100%" role="img"
      aria-label={"Synthetic technical fixture h1-scatter-spacing"} data-chart-kind={"scatter"}>
