...
const chart: ChartGeometry = {"area_points": "", "bars": [], "baseline": null, "bottom": 316.0, "categories": ["A", "B", "C"], "domain": null, "height": 400, "kind": "pie", "left": 64.0, "line_points": "", "points": [], "right": 604.0, "slices": [{"fraction": 0.4, "index": 0, "label": "A", "path": "M 320 170 L 320 30 A 140 140 0 0 1 402.289935321 283.262379212 Z", "value": 2.0}, {"fraction": 0.6, "index": 1, "label": "B", "path": "M 320 170 L 402.289935321 283.262379212 A 140 140 0 1 1 320 30 Z", "value": 3.0}], "top": 32.0, "units": "", "values": [2.0, 3.0, 0.0], "width": 640, "x_label": "", "y_label": ""};
export const Chart_e0_5c88e7a2: React.FC = () => (
  <figure style={{margin: 0, width: "100%", height: "100%", display: "grid", gridTemplateRows: "minmax(0, 1fr) auto"}}>
    <svg viewBox="0 0 640 400" width="100%" height="100%" role="img"
      aria-label={"Synthetic technical fixture h1-pie-native"} data-chart-kind={"pie"}>
