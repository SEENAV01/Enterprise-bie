...
const vector = {"components": [0.0, 0.0], "dimensions": 2, "endpoint": [200.0, 145.0], "is_zero": true, "label": "", "origin": [200, 145], "projected": [0.0, 0.0], "projection_label": "2D Cartesian (x right, y up)", "projection_matrix": null, "scale_px_per_unit": 1.0, "units": ""};
export const Vector_e0_5c88e7a2: React.FC = () => (
  <svg viewBox="0 0 400 320" width="100%" height="100%" role="img" aria-label={"Synthetic technical fixture h1-vector-zero"}>
