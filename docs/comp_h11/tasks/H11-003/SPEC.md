# BIE-COMP-H11-003 — Video trims and time-indexed clip lifecycle

Source-byte-verified CFR video; exact composition-frame mapping and explicit audio handling; pinned media dependency adoption.
...
Tests: `PYTHONPATH=app:. PYTHONDONTWRITEBYTECODE=1 python -m unittest tests.compiler.test_comp_h11_003 -v` (25 tests). Actual pre-package execution is in TEST_RESULT.txt; final extracted release execution is bound externally to the integrated archive SHA256.
