# BIE-DIR-TIME-001 — speech timing

Owned source: bie/director/timing_contract.py, bie/director/speech_timing.py

Direct task dependencies: BIE-DIR-SCRIPT-001, BIE-DIR-SCRIPT-002.
