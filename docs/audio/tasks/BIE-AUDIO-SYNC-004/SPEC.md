# BIE-AUDIO-SYNC-004 — animation sync

Original AUDIO Section 14 task; continuation from VO-010. Actual required behavior, input/output contracts, rejection modes and precise evidence boundaries are in `docs/audio/BATCH003_CONTRACTS.md` under SYNC-004. No new original task IDs invented.

Run `python scripts/run_audio_tests.py --pattern test_audio_sync_004.py --output /tmp/sync-004.json`.
