# BIE-AUDIO-H2-003 — Externally configured evaluator trust and signed receipts

Engineering subdivision of existing F02, not an original registry addition.

Owned implementation: `bie/audio/acoustic_evidence.py`.

Verification: `python -B scripts/run_audio_tests.py --pattern test_audio_h2_003.py --output /tmp/BIE-AUDIO-H2-003.json`.
