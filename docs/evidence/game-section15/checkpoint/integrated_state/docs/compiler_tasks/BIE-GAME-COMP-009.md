# BIE-GAME-COMP-009 — adaptation compiler
...
- actual predicate functions
- target/action binding
- priority ties rejected
...
## Source
`bie/game_engine/compiler_engine/adaptation_compiler.py`

## Tests
`tests/compiler_engine/test_bie_game_comp_009.py` plus compiler architecture/security/typecheck/browser suites.
