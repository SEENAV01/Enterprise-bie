# BIE-GAME-COMP-005 — rule compiler
...
- safe AST-to-TypeScript predicates
- actual predicate functions, no condition eval
- effects/priority/grounding preserved
- strict TypeScript
...
## Source
`bie/game_engine/compiler_engine/rule_compiler.py`

## Tests
`tests/compiler_engine/test_bie_game_comp_005.py` plus compiler architecture/security/typecheck/browser suites.
