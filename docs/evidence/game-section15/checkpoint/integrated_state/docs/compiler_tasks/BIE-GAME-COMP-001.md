# BIE-GAME-COMP-001 — Game IR compiler
...
- strict Batch01 wire codec
- content-addressed canonical IR
- document fingerprint preservation
- no lossy migration
...
## Source
`bie/game_engine/compiler_engine/game_ir.py`

## Tests
`tests/compiler_engine/test_bie_game_comp_001.py` plus compiler architecture/security/typecheck/browser suites.
