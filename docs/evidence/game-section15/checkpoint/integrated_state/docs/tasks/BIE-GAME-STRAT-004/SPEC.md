# BIE-GAME-STRAT-004 — Simulation strategy

## Purpose
Evidence-bounded model experimentation with declared model scope, meaningful parameters, observable outputs and semantic motion.
...
## Implementation
`bie/game_engine/strategy_engine/simulation.py`
