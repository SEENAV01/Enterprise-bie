# BIE-GAME-STRAT-002 — Retrieval strategy

## Purpose
Grounded active-recall strategy with spacing-ready items, misconception targeting, answer-reveal discipline and no MCQ-only core experience.
...
## Implementation
`bie/game_engine/strategy_engine/retrieval.py`
