# BIE-GAME-STRAT-006 — Diagnostic strategy

## Purpose
Misconception-grounded error diagnosis with explanatory feedback and no gotcha traps.
...
## Implementation
`bie/game_engine/strategy_engine/diagnostic.py`
