# BIE-GAME-STRAT-008 — Map strategy

## Purpose
Grounded geospatial reasoning where the map is an interactive semantic workspace, not a decorative background.
...
## Implementation
`bie/game_engine/strategy_engine/map_strategy.py`
