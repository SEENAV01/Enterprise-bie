# BIE-GAME-MECH-014 — diagnose error
...
## Purpose
Implement **diagnose error** as a semantic learning interaction, not a decorative UI gesture or slide transition.

## Architecture
- Implementation module: `bie/game_engine/mechanics_engine/diagnose_error.py`
