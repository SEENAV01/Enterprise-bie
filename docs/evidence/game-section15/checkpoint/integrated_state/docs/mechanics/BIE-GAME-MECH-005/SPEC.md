# BIE-GAME-MECH-005 — classify/sort
...
## Purpose
Implement **classify/sort** as a semantic learning interaction, not a decorative UI gesture or slide transition.

## Architecture
- Implementation module: `bie/game_engine/mechanics_engine/classify_sort.py`
