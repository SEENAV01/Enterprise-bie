...
def compile_telemetry(ctx:CompilerContext):
    ...
    payload_allowlist=('event','game_id','level_id','challenge_id','attempt_number','outcome_code','mechanic_id','duration_bucket')
    data={'schema_version':'bie.game.telemetry-program/1','events':events,'payload_allowlist':payload_allowlist,'raw_text_allowed':False,'remote_endpoint':None,'product_accepted':False}
