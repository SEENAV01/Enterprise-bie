...
ctx=sample_context
from bie.game_engine.mechanics_engine import timeline_reconstruction
def valid():return timeline_reconstruction.execute(ctx(),{},[{'id':'e1','time':1},{'id':'e2','time':2}],('e1','e2'))
def invalids():return [(lambda:timeline_reconstruction.execute(ctx(),{},[],())),(lambda:timeline_reconstruction.execute(ctx(),{},[{'id':'e1'}],('e1',)))]
from bie.game_engine.mechanics_engine import timeline_reconstruction as MODULE
