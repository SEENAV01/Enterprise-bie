...
ctx=sample_context
from bie.game_engine.mechanics_engine import spatial_arrangement
def valid():return spatial_arrangement.execute(ctx(),{}, {'a':(0,1),'b':(1,0)}, [('a','b','left_of'),('a','b','above')])
def invalids():return [(lambda:spatial_arrangement.execute(ctx(),{}, {'a':(0,0)}, [])),(lambda:spatial_arrangement.execute(ctx(),{}, {'a':(0,0),'b':(1,1)}, [('a','x','left_of')]))]
from bie.game_engine.mechanics_engine import spatial_arrangement as MODULE
