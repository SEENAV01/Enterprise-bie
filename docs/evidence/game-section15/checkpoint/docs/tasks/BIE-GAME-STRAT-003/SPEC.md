# BIE-GAME-STRAT-003 — Manipulation strategy

## Purpose
Bounded reversible semantic state manipulation with observable causal effects, semantic motion and accessible direct manipulation.
...
## Implementation
`bie/game_engine/strategy_engine/manipulation.py`
