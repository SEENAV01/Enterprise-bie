# BIE-GAME-STRAT-010 — Causal-system strategy

## Purpose
Evidence-backed causal graph intervention strategy with causal/correlation boundary and no inferred unproven edges.
...
## Implementation
`bie/game_engine/strategy_engine/causal_system.py`
