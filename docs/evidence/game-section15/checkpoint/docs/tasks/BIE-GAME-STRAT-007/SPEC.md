# BIE-GAME-STRAT-007 — Timeline strategy

## Purpose
Evidence-backed temporal reconstruction with stable ordering, accessible reordering and chronology/causality separation.
...
## Implementation
`bie/game_engine/strategy_engine/timeline.py`
