# BIE-GAME-COMP-006 — interaction compiler
...
- keyboard parity propagated
- semantic mechanic events bound
- state before/after hashes preserved
...
## Source
`bie/game_engine/compiler_engine/interaction_compiler.py`

## Tests
`tests/compiler_engine/test_bie_game_comp_006.py` plus compiler architecture/security/typecheck/browser suites.
