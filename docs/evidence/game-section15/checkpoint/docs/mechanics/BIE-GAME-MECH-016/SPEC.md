# BIE-GAME-MECH-016 — resource tradeoff
...
## Purpose
Implement **resource tradeoff** as a semantic learning interaction, not a decorative UI gesture or slide transition.

## Architecture
- Implementation module: `bie/game_engine/mechanics_engine/resource_tradeoff.py`
