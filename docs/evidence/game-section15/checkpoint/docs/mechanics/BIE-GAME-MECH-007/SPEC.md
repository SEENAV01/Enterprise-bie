# BIE-GAME-MECH-007 — simulation experiment
...
## Purpose
Implement **simulation experiment** as a semantic learning interaction, not a decorative UI gesture or slide transition.

## Architecture
- Implementation module: `bie/game_engine/mechanics_engine/simulation_experiment.py`
