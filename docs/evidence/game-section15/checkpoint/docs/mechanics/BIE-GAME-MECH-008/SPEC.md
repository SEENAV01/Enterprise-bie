# BIE-GAME-MECH-008 — graph exploration
...
## Purpose
Implement **graph exploration** as a semantic learning interaction, not a decorative UI gesture or slide transition.

## Architecture
- Implementation module: `bie/game_engine/mechanics_engine/graph_exploration.py`
